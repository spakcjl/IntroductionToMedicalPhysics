...
# Configure reticulate to use the project's virtual environment Python
# This ensures that packages installed in .venv are available.
venv_path <- file.path(getwd(), "..", ".venv", "bin", "python3")
if (!file.exists(venv_path)) {
  # Try relative to root if getwd() is already root
  venv_path <- file.path(getwd(), ".venv", "bin", "python3")
}
...
tryCatch({
  ...
  message("Project virtual environment Python not found. Falling back to system Python.")
  tryCatch({
    use_python(Sys.which("python3"), required = TRUE)
  }, error = function(e2) {
    message("Python3 not found. Python chunks will not work.")
  })
})
```
...
### Visualization: Continuous vs. Discrete Code

```{python continuous_discrete_plot_code, echo=TRUE}
import numpy as np
...
### The Rectangular Function: Visualization Code
```{python rect_function_plot_code, echo=TRUE}
import numpy as np
import matplotlib.pyplot as plt
...
### The Sinc Function: Visualization Code
```{python sinc_function_plot_code, echo=TRUE}
import numpy as np
import matplotlib.pyplot as plt
...
### The Dirac Delta Function: Visualization Code
```{python dirac_delta_plot_code, echo=TRUE}
import numpy as np
import matplotlib.pyplot as plt
...
### The Comb Function: Visualization Code
```{python comb_function_plot_code, echo=TRUE}
import numpy as np
import matplotlib.pyplot as plt
...
plt.xlabel("t")
plt.tick_params(axis='y', which='both', left=False, right=False, labelleft=False)
comb_function_plot_fig = plt.gcf()
```
...
aliasing_plot_good_fig = plt.gcf()
...
### Convolution: Graphical Example Code
```{python conv_viz_code, echo=TRUE}
import numpy as np
import matplotlib.pyplot as plt
...
noise_appearance_plot_fig = plt.gcf()
```
...
ax3.set_title("CNR = 5")
ax3.axis('off')
rose_criterion_plots_fig = plt.gcf()
```
...
### Fourier Slice Theorem: Conceptual Diagram Code

```{python fst_diagram_code, echo=TRUE}
import numpy as np
import matplotlib.pyplot as plt
...
plt.axis('off')
backprojection_plot_fig = plt.gcf()
```
...
### The Ramp Filter: Visualization Code
```{python ramp_filter_plot_code, echo=TRUE}
import numpy as np
import matplotlib.pyplot as plt
...
ax3.axis('off')
kspace_filter_plot_fig = plt.gcf()
```
...
### Beamforming: Conceptual Diagram Code

```{python beamforming_diagram_code, echo=TRUE}
import numpy as np
import matplotlib.pyplot as plt
...
ax.axis('off')
beamforming_diagram_fig = plt.gcf()
```
...
### Sparsity: Conceptual Diagram Code
```{python sparsity_diagram_code, echo=TRUE}
import numpy as np
import matplotlib.pyplot as plt
...
::: notes
Think back to our convolution examples. We designed a simple averaging filter for denoising. A CNN might learn thousands of different, complex filter shapes that are perfectly optimized for a specific type of noise from a CT image, or for highlighting the texture of a tumor. They are essentially "learned filters."
...
### CNN Architecture: Conceptual Diagram Code
```{python cnn_diagram_code, echo=TRUE}
import matplotlib.pyplot as plt
